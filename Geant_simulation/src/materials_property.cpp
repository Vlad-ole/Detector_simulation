...
void DetectorConstruction::defineMaterials()
{
	...
	G4double LAr_rindices[LAr_numentries] = { 1.23, 1.23 }; // https://arxiv.org/pdf/1502.04213v2.pdf (page 10) Index of refraction, Rayleigh scattering length, and Sellmeier coefficients (200-700)
